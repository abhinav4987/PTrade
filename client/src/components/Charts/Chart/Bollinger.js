...
function BollingerChart({chartData, width, type, ratio, time}) {
    ...
    const bb = bollingerBand()
			.merge((d, c) => {d.bb = c;})
			.accessor(d => d.bb);
    const calculatedData = bb(chartData);
    const {
        data,
        xScale,
        // xAccessor,
...
BollingerChart.defaultProps = {
    type: "svg",
};

BollingerChart = fitWidth(BollingerChart)
