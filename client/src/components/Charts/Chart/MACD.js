...
import { ema, wma, sma, tma,macd, bollingerBand } from "react-stockcharts/lib/indicator";
...
function MACDChart({chartData, width, type, ratio, time}) {
        ...
        <div className="Charts">
            ...
            >
                ...
                >
                    ...
                    <OHLCTooltip origin={[0, 0]} fontSize={14}/>
                    <CrossHairCursor />             
                </Chart>    
                <Chart id={2} origin={(w, h) => [0, h - 250]} height={100}  yExtents={d => d.volume}>
                ...
                <Chart id={3} height={150}
					...
					origin={(w, h) => [0, h - 150]} padding={{ top: 50, bottom: 10 }}
				>
