...
import { ema,rsi, wma, sma, tma, bollingerBand } from "react-stockcharts/lib/indicator";
import { last, timeIntervalBarWidth } from "react-stockcharts/lib/utils";
import { CandlestickSeries,BarSeries,RSISeries,LineSeries } from "react-stockcharts/lib/series";
...
function RSI({chartData, width, type, ratio, time}) {
    ...
    const rsiCalculator = rsi()
			...
			.merge((d, c) => {d.rsi = c;})
			.accessor(d => d.rsi);
    const calculatedData = rsiCalculator(chartData);
    const {
        data,
        xScale,
        // xAccessor,
